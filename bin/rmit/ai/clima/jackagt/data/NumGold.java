...
public class NumGold extends aos.jack.jak.beliefset.ClosedWorld {
    static public rmit.ai.clima.jackagt.data.NumGold__Tuple __hole = new rmit.ai.clima.jackagt.data.NumGold__Tuple(true);
    public rmit.ai.clima.jackagt.data.NumGold__Tuple[][] __tables;
    ...
    {
        rmit.ai.clima.jackagt.data.NumGold__Tuple __t = new rmit.ai.clima.jackagt.data.NumGold__Tuple();
        rmit.ai.clima.jackagt.data.NumGold.__Cursor __c = new rmit.ai.clima.jackagt.data.NumGold.__Cursor(__t);
        if (!__v0.check_unifiable(java.lang.Integer.TYPE)) 
            throw new aos.jack.jak.beliefset.BeliefSetException("NumGold:get:O: arg 0 numGold Incorrect Variable type");
        if (__v0.isGround()) {
            try {
                __t.numGold = __v0.as_int();
            }
            catch (java.lang.Exception e) {
                throw new aos.jack.jak.beliefset.BeliefSetException("NumGold:get:O: got " + e.toString());
            }
        }
         else 
            __c.numGold = __v0;
    ...
    {
        return new rmit.ai.clima.jackagt.data.NumGold__Tuple();
    }
    ...
    {
        return new rmit.ai.clima.jackagt.data.NumGold__Tuple[t];
    }
    ...
    {
        __tables = (rmit.ai.clima.jackagt.data.NumGold__Tuple[][]) t;
    }
    
    public aos.jack.jak.beliefset.BeliefSetCursor newCursor(aos.jack.jak.beliefset.Tuple __t)
    {
        if (__t instanceof rmit.ai.clima.jackagt.data.NumGold__Tuple) 
            return new rmit.ai.clima.jackagt.data.NumGold.__Cursor((rmit.ai.clima.jackagt.data.NumGold__Tuple) __t);
        return null;
    }
    ...
    public NumGold(java.lang.String n)
    {
        super();
        read(n);
    }
    ...
    class __Cursor extends aos.jack.jak.beliefset.ClosedWorldCursor {
        public rmit.ai.clima.jackagt.data.NumGold__Tuple __tuple = null;
        public aos.jack.jak.logic.Variable numGold;
        public __Cursor()
        {
            __tuple = __hole;
        }
        
        public __Cursor(rmit.ai.clima.jackagt.data.NumGold__Tuple __t)
        {
            super();
            __tuple = __t;
        }
        ...
        {
            rmit.ai.clima.jackagt.data.NumGold__Tuple[] __tab = __tables[__ti];
            rmit.ai.clima.jackagt.data.NumGold__Tuple __t;
            int __sz = __tab.length;
            int __i;
            if ((aos.jack.jak.core.Jak.debugging & aos.jack.jak.core.Jak.LOG_DB) != 0) {
                aos.jack.jak.core.Jak.log.log("NumGold__Tuple:match:" + __ti + ":" + __st + ":" + __c + ":" + __k + ":" + __ind);
                aos.jack.jak.core.Jak.log.log("Tuple=" + __tuple);
                aos.jack.jak.core.Jak.log.log("Outputs are");
                aos.jack.jak.core.Jak.log.log("  numGold:" + numGold);
            }
            for (__i = __st; __c > 0; __i = (__i + 1) % __sz, __c-- ) {
                ...
                try {
                    ...
                    if (__k) 
                        return __i;
                    if (numGold == null) {
                        if (__tuple.numGold != __t.numGold) 
                            continue;
                    }
                     else {
                        if (!numGold.unify(__t.numGold)) 
                            continue;
                    }
                }
                catch (java.lang.Exception e) {
        ...
        {
            if (numGold != null) 
                return numGold.getEnv().newChoicePoint();
            return null;
        }
