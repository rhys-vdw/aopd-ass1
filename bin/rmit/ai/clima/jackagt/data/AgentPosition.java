...
public class AgentPosition extends aos.jack.jak.beliefset.ClosedWorld {
    static public rmit.ai.clima.jackagt.data.AgentPosition__Tuple __hole = new rmit.ai.clima.jackagt.data.AgentPosition__Tuple(true);
    public rmit.ai.clima.jackagt.data.AgentPosition__Tuple[][] __tables;
    ...
    {
        rmit.ai.clima.jackagt.data.AgentPosition__Tuple __t = new rmit.ai.clima.jackagt.data.AgentPosition__Tuple();
        rmit.ai.clima.jackagt.data.AgentPosition.__Cursor __c = new rmit.ai.clima.jackagt.data.AgentPosition.__Cursor(__t);
        if (!__v0.check_unifiable(StringType)) 
            throw new aos.jack.jak.beliefset.BeliefSetException("AgentPosition:get:OOO: arg 0 agentName Incorrect Variable type");
        if (__v0.isGround()) {
            try {
                __t.agentName = __v0.as_string();
            }
            catch (java.lang.Exception e) {
                throw new aos.jack.jak.beliefset.BeliefSetException("AgentPosition:get:OOO: got " + e.toString());
            }
        }
         else 
            __c.agentName = __v0;
        if (!__v1.check_unifiable(java.lang.Integer.TYPE)) 
            throw new aos.jack.jak.beliefset.BeliefSetException("AgentPosition:get:OOO: arg 1 posX Incorrect Variable type");
        if (__v1.isGround()) {
            try {
        ...
        if (!__v2.check_unifiable(java.lang.Integer.TYPE)) 
            throw new aos.jack.jak.beliefset.BeliefSetException("AgentPosition:get:OOO: arg 2 posY Incorrect Variable type");
        if (__v2.isGround()) {
            try {
    ...
    public aos.jack.jak.beliefset.BeliefSetCursor get(java.lang.String __v0, aos.jack.jak.logic.IntegerVariable __v1, aos.jack.jak.logic.IntegerVariable __v2)
        throws aos.jack.jak.beliefset.BeliefSetException
    {
        rmit.ai.clima.jackagt.data.AgentPosition__Tuple __t = new rmit.ai.clima.jackagt.data.AgentPosition__Tuple();
        rmit.ai.clima.jackagt.data.AgentPosition.__Cursor __c = new rmit.ai.clima.jackagt.data.AgentPosition.__Cursor(__t);
        __t.agentName = __v0;
        if (!__v1.check_unifiable(java.lang.Integer.TYPE)) 
            throw new aos.jack.jak.beliefset.BeliefSetException("AgentPosition:get:IOO: arg 1 posX Incorrect Variable type");
        if (__v1.isGround()) {
            try {
                __t.posX = __v1.as_int();
            }
            catch (java.lang.Exception e) {
                throw new aos.jack.jak.beliefset.BeliefSetException("AgentPosition:get:IOO: got " + e.toString());
            }
        }
         else 
            __c.posX = __v1;
        if (!__v2.check_unifiable(java.lang.Integer.TYPE)) 
            throw new aos.jack.jak.beliefset.BeliefSetException("AgentPosition:get:IOO: arg 2 posY Incorrect Variable type");
        if (__v2.isGround()) {
            try {
                __t.posY = __v2.as_int();
            }
    ...
    {
        return new rmit.ai.clima.jackagt.data.AgentPosition__Tuple();
    }
    ...
    {
        return new rmit.ai.clima.jackagt.data.AgentPosition__Tuple[t];
    }
    ...
    {
        __tables = (rmit.ai.clima.jackagt.data.AgentPosition__Tuple[][]) t;
    }
    
    public aos.jack.jak.beliefset.BeliefSetCursor newCursor(aos.jack.jak.beliefset.Tuple __t)
    {
        if (__t instanceof rmit.ai.clima.jackagt.data.AgentPosition__Tuple) 
            return new rmit.ai.clima.jackagt.data.AgentPosition.__Cursor((rmit.ai.clima.jackagt.data.AgentPosition__Tuple) __t);
        return null;
    }
    ...
    public AgentPosition(java.lang.String n)
    {
        super();
        read(n);
    }
    ...
    class __Cursor extends aos.jack.jak.beliefset.ClosedWorldCursor {
        public rmit.ai.clima.jackagt.data.AgentPosition__Tuple __tuple = null;
        ...
        public __Cursor(rmit.ai.clima.jackagt.data.AgentPosition__Tuple __t)
        {
            super();
            __tuple = __t;
        }
        ...
        {
            rmit.ai.clima.jackagt.data.AgentPosition__Tuple[] __tab = __tables[__ti];
            rmit.ai.clima.jackagt.data.AgentPosition__Tuple __t;
            int __sz = __tab.length;
            int __i;
            if ((aos.jack.jak.core.Jak.debugging & aos.jack.jak.core.Jak.LOG_DB) != 0) {
                aos.jack.jak.core.Jak.log.log("AgentPosition__Tuple:match:" + __ti + ":" + __st + ":" + __c + ":" + __k + ":" + __ind);
