...
public class NumGold__Tuple extends aos.jack.jak.beliefset.Tuple implements aos.apib.Base, java.io.Serializable {
...
public NumGold__Tuple(boolean v)
{
    super();
    isFree = v;
}
...
public int hash(int __i)
{
  ...
  public NumGold__Tuple() {
    streamer.setup();
    if (!getStreamer().initialized) return;
    __init__NumGold__Tuple();
  }

  /** Automatically generated method. */
  void __init__NumGold__Tuple() {
	numGold = 0;
  ...
  static class __SS extends aos.apib.StreamerSupport {
    ...
    protected void setup() {
      ...
      __def = (NumGold__Tuple)newInstance();
    ...
    public aos.apib.Base new_instance() {
      return new NumGold__Tuple();
    }

    /** JACOB method. */
    public aos.apib.Base[] new_array(int n) {
      return new NumGold__Tuple[n];
    }
    ...
    public boolean readField(aos.apib.InStream in, aos.apib.Base o,int i) {
      ...
      NumGold__Tuple v = (NumGold__Tuple)o;
      switch (i) {
      case 0:
	v.numGold = in.getInt();
	break;
      ...
      default:
        if (i >= 0 && i <= 1) break;
        in.error("Reader for NumGold__Tuple: illegal field number:"+i);
        return false;
      }
      return true;
    }
    ...
    public boolean write(aos.apib.OutStream out, aos.apib.Base o) {
      ...
      while ((i = out.nextField(i, this)) >= 0) {
        switch (i) {
      case 0:
	out.putInt(v.numGold, i, __def.numGold, this);
	break;
        case 1:
        ...
        default:
          if (i >= 0 && i <= 1) break;
          out.error("Writer for NumGold__Tuple: illegal field number:"+i);
          return false;
        }
      }
      return true;
	...
	if (v.numGold != __def.numGold) return false;
