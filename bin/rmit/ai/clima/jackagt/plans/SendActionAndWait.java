    ...
    class __bodyFSM extends aos.jack.jak.plan.PlanFSM implements aos.jack.jak.core.Generator {
            ...
            do {
                try {
                    ...
                    switch (__state) {
                        ...
                        {
                            __state = 13;
                            agent.postEvent(tellclimaserver_p.tell(new rmit.ai.clima.comms.Action(eexecuteclimaaction_h.message,getAgent().name(),"" + __local__18_0.as_int())));
                            break;
                        }
                        ...
                        case 13: 
                        {
                            ...
                            debugIface.showConsoleDebug("I sent CLIMA action *" + eexecuteclimaaction_h.message + "* for execution with id " + __local__18_0.as_int());
                            break;
                        }
            ...
            throws java.lang.Exception
        {
            switch (__index) {
                case 0: 
                {
                    return (bel_currentRequestActionId_dat.query_id(__local__18_0));
                }
            }
            aos.jack.jak.core.Jak.error("illegal Cursor Construction");
            return null;
