...
public class UpdateCellsAround extends aos.jack.jak.plan.Plan {
    ...
    class __bodyFSM extends aos.jack.jak.plan.PlanFSM implements aos.jack.jak.core.Generator {
        ...
        int __local__25_6;
        rmit.ai.clima.gui.grid.GridPoint __local__25_7;
        int __local__25_8;
        java.lang.String __local__25_9;
        aos.jack.jak.cursor.BeliefState __local__25_10;
            ...
            do {
                try {
                    ...
                    switch (__state) {
                        ...
                        case 15: 
                        {
                            if (__local__25_6 < __local__25_3.length) 
                                __state = 16;
                             else 
                                __state = 30;
                            break;
...
// Calculate the exact point of cells[i]: store it in GridPoint loc
                            ...
                            __local__25_4 = __local__25_3[__local__25_6].id;
                            break;
                        }
                        //* (58)             GridPoint loc = GridPoint.getFromDir(posX, posY, locDir);
                        case 17: 
                        {
                            __local__25_7 = rmit.ai.clima.gui.grid.GridPoint.getFromDir(__local__25_1,__local__25_2,__local__25_4);
                            __state = 18;
                            break;
                        }
                        ...
                        case 19: 
                        {
                            if (__local__25_8 < __local__25_3[__local__25_6].marks.length) 
                                __state = 20;
                             else 
                                __state = 29;
                            break;
                        ...
                        {
                            __breakLevel = 8;
                            __local__25_9 = __local__25_3[__local__25_6].marks[__local__25_8].type;
                            __state = 21;
                            break;
                        }
                        ...
                        case 21: 
                        {
                            if (__local__25_9.equalsIgnoreCase("unknown") == false) 
                                __state = 22;
                             else 
                                __state = 28;
                            break;
                        ...
                        {
                            __breakLevel = 10;
                            if (__local__25_9.equalsIgnoreCase("obstacle")) 
                                __state = 23;
                             else 
                                __state = 25;
                            break;
                        ...
                        case 23: 
                        {
                            ...
                            bel_cellEmpty_dat.add(__local__25_7.x,__local__25_7.y,aos.jack.jak.cursor.Cursor.FALSE);
                            break;
                        }
                        ...
                        {
                            __state = 28;
                            bel_goldAt_dat.add(__local__25_7.x,__local__25_7.y,aos.jack.jak.cursor.Cursor.FALSE);
                            break;
                        }
                        ...
                        case 25: 
                        {
                            ...
                            bel_cellEmpty_dat.add(__local__25_7.x,__local__25_7.y,aos.jack.jak.cursor.Cursor.TRUE);
                            break;
                        }
                        //* (78)                         BeliefState hasGold = cellType.equalsIgnoreCase("gold") ?
                        case 26: 
                        {
                            __local__25_10 = __local__25_9.equalsIgnoreCase("gold")?aos.jack.jak.cursor.Cursor.TRUE:aos.jack.jak.cursor.Cursor.FALSE;
                            __state = 27;
                            break;
                        }
                        ...
                        {
                            __state = 28;
                            bel_goldAt_dat.add(__local__25_7.x,__local__25_7.y,__local__25_10);
                            break;
                        }
                        //* (61)            for(int j = 0; j < cells[i].marks.length; j++) {
                        case 28: 
        ...
        public java.lang.Object getVariable(int n)
        {
            switch (n) {
                ...
                case 10: 
                {
                    return aos.util.ToObject.box(__local__25_10);
                }
                default: 
                {
