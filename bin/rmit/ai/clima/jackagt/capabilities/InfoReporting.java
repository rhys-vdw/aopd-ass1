...
import rmit.ai.clima.jackagt.plans.ReportCurrentPositionChange;
...
public class InfoReporting extends aos.jack.jak.agent.Capability {
    ...
    public void __init1()
    {
        setNamedCreator("bel_numCarryingGold_dat","rmit.ai.clima.jackagt.data.NumGold",new aos.jack.jak.agent.DataCreator(false){
    ...
    public void __init2()
    {
        bel_numCarryingGold_dat = (rmit.ai.clima.jackagt.data.NumGold) getNamedObject("bel_numCarryingGold_dat","rmit.ai.clima.jackagt.data.NumGold");
        ...
        meinformcurrentpositionchange_p = (rmit.ai.clima.jackagt.events.MEInformCurrentPositionChange) findEvent("rmit.ai.clima.jackagt.events.MEInformCurrentPositionChange");
    ...
    synchronized public void __init_desc()
    {
        ...
        externals.put("rmit.ai.clima.jackagt.events.ECurrentPositionChange","rmit.ai.clima.jackagt.events.ECurrentPositionChange");
        ...
        addEvent("rmit.ai.clima.jackagt.events.MEInformCurrentPositionChange",aos.jack.jak.agent.Agent.POSTED_EVENT);
        addEvent("rmit.ai.clima.jackagt.events.EShowBeliefs",aos.jack.jak.agent.Agent.HANDLED_EVENT);
        addEvent("rmit.ai.clima.jackagt.events.ECurrentPositionChange",aos.jack.jak.agent.Agent.HANDLED_EVENT);
        ...
        addPlan("rmit.ai.clima.jackagt.plans.ReportCurrentPositionChange",0);
    ...
    synchronized public void __bindNames()
    {
        ...
        __bindToPlan("rmit.ai.clima.jackagt.plans.ReportCurrentPositionChange");
